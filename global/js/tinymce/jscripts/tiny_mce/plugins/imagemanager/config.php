<?php
	...
	//$mcImageManagerConfig['filesystem.rootpath'] = '/home/centroco/public_html/uploads'; // absolute or relative from this script path, required.
        $mcImageManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'].'/uploads';
